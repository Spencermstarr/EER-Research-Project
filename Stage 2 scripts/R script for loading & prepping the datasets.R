...
#save.image("D:/EER/Saved WorkSpaces/Workspaces for dataset folders starting with '0.5'/datasets WorkSpace for 0.5-12-1-1 to 0.5-12-10-500.RData")
...
#save.image("D:/EER folder/WorkSpaces/datasets WorkSpace for 0.5-12-1-1 to 0.5-12-10-500 datasets.RData")

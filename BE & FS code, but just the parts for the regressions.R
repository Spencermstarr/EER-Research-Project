...
write.csv(df, 
          file = "SR's Performance on the DSs from 0.75-5-1-1 to 0.75-6-10-500.csv", 
          row.names = FALSE)
...
write.csv(data.frame(DS_name = DS_names_list, 
          ...
          file = "Regressors Selected by SR for DSs from 0.75-5-1-1 to 0.75-6-10-500.csv", 
          row.names = FALSE)
...
#save.image("D:/EER/Saved WorkSpaces/BE & FS WorkSpace for the 10k '0-12-1-1 to 0-12-10-500' datasets.RData")

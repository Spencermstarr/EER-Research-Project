...
set.seed(11)     # to ensure replicability
Elastic_Net_Coeffs <- lapply(Elastic_Net_fits, 
...
Elastic_Net_Coeffs[[1]]
all_Coeffs_estimated_by_1st_Elastic_Net <- Elastic_Net_Coeffs[[1]]
all_Coeffs_estimated_by_1st_Elastic_Net
Elastic_Net_Coeffs[[1]][["X1"]]
Elastic_Net_Coeffs[[1]][["intercept"]]
Elastic_Net_Coeffs[[1]][["Intercept"]]
...
positive_coeffs <- lapply(Elastic_Net_Coeffs, function(i) i[i > 0])
positive_coeffs[1]
positive_coeffs[[1]]


IVs_selected_by_Elastic_Net <- lapply(Elastic_Net_Coeffs, function(i) names(i[i > 0]))

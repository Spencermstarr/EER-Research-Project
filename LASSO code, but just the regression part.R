...
#rm(list = ls())
#system.time( load("C:/Users/Spencer/OneDrive/Documents/Analytics Projects/Estimated Exhaustive Regression Project/Saved WorkSpaces/datasets WorkSpace for '0-5-1-1 to 0-6-10-500'.RData") )
...
write.csv(performance_metrics, 
          file = "(corrected)LASSO's Performance on the datasets from 0-5-1-1 to 0-6-10-500.csv", 
          row.names = FALSE)
